...
class TestPostJsonEndpoints:
    #some server should play (add also for true)
    ...
    @pytest.mark.skip(reason="not supported in development")
    ...
    @pytest.mark.skip(reason="not allowed (returns 405), in master server there is not function called that")
   ...
   ##the geo should work to do restart
